...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="udpFactura" UpdateMode="Conditional" runat="server">
                    ...
                    <div class="container uniform">
                        ...
                        <div class="row margin-b 12u$(xsmall)">
							...
							<div class="col-sm-7 col-md-9">
                                ...
                                <asp:Button ID="btnFinalizarLaFactura" runat="server" OnClick="btnFinalizarLaFactura_Click" Text="Finalizar Factura" CssClass="btn btn-primary" />
                            </div>
                        </div>
                        <div class="row margin-b 12u$(xsmall)">
							<div class="col-sm-5 col-md-3">
							...
							<section id="three" class="container spotlight style3">
								<div class="inner">
									<div class="content">
                                        <div class="row margin-b 6u 12u$(xsmall)">
							<div class="col-sm-5 col-md-3">
								<label for="demo-name">Búsqueda por número de factura:</label>
							</div>
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="btnFinalizarLaFactura" EventName="Click" />
